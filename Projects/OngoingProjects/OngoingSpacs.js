    ...
    //   }
      const openGallery = async () => {
        try {
          ...
          setGalleryPhoto(result.assets[0].uri)
          setSpaceImages(result)

          console.log(result.assets,"result resultttttttttttttttttttttttttt")
      ...
      const onPressFinalizedDesigns=()=>{
        navigation.replace('FinalizedDesigns', { screen: 'FinalizedDesigns' });
      }
           ...
           <TouchableOpacity style={styles.cancelButton} onPress={toggleModal}>
            ...
            <ScrollView>
                ...
                {spaceDetails.map(eachItem=>
                  <OngoingSpaceCard spaceDetails={eachItem} key={eachItem.spaceId}/>)}
                  </View>
                  </ScrollView>
                </View>
            </ScrollView>
