...
const ExploreFeed=(props)=>{
    ...
    return(
      ...
      {splitedUrl=="mp4"?  <Video
           ref={video}
           source={{uri:`http://192.168.1.36:9000/${thumbnail}`}} 
           useNativeControls
           ...
           style={styles.cardImage}
             controls={true} 
         />:
       <Image source={{uri:`http://192.168.1.36:9000/${thumbnail}`}} style={styles.cardImage} />}
       {/* <Text style={styles.projectName}>hjghjgh</Text> */}
        ...
        //  />:     <Image  source={{uri:`http://192.168.1.36:9000/${thumbnail}`}}  style={{height:170,width:150,borderRadius:3,margin:6}} resizeMode='contain' />}
        // </View>
    )
}
