  ...
  const pickImage = async () => {
    ...
    const handleApiCall = async () => {
      ...
      if (selectedFile) {
        ...
        try {
          const response = await axios.post('http://192.168.1.36:9000/designer/signup/', formDataToSend, {
            headers: {
    ...
    //   try {
    //     const response = await axios.post('http://192.168.1.36:9000/designer/signup/', formData, {
    //       headers: {
    //         'Content-Type': 'multipart/form-data',
    //       },
    //     });
